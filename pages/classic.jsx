        ...
        <>
            ...
            <div className="section-wrapper inner-section inner-section-padding card-comparator">
                <div className="listed-card-wrapper">
                    ...
                    <div className="listed-card flex not-hidden">
                        <div className="flex">
                            <div className={`active-card-features ${accordion3 ? "mb-0" : ""}`}>
                                <div className="">
                                    <h3 className={`active-card-title w-50 flex justify-between flex ${accordion3 ? "mb-0 w-100" : ""}`}>
                                        <span className=''>Votre carte de visite réinventée</span>
                                        <div>
                                            <span className={`link-icon mobile-accordion-btn ${accordion3 ? "open" : "closed"}`} onClick={() => setAccordion3(!accordion3)}> <svg width="16" height="9" viewBox="0 0 16 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M0.0834961 8.16666L8.00016 0.249997L15.9168 8.16666H0.0834961Z" fill="#CBD6E2" />
                                            </svg>
                                            </span>
                                        </div>
                                    </h3>
                                    <div className={`card-number ${accordion3 ? "hidden" : ""}`}>
                                        <span className="bold">Model No:</span>
                                        <span className="paragraph">ZAE054</span>
                                    </div>
                                </div>
                                <div className={`card-feature-box ${accordion3 ? "hidden mb-0" : "flex"}`}>
                        ...
                        <div className={`card-example-preview h-100 ${accordion3 ? "hidden" : "flex"}`}>
                    ...
                    <div className="listed-card card-services-details flex align-center">
                        ...
                        <div className={`card-composition mobile-accordion-elements ${accordion1 ? "card-hidden-elements" : ""}`}>
                            <p className="text-third mb-10">Matière</p>
                            <p className="paragraph">PVC</p>
                        </div>
                        <div className={`card-feature-box ${accordion1 ? "hidden" : "flex mb-30"}`}>
                            <div className="card-feature">
                                <div className="item-icon">
                                    <svg width="47" height="47" viewBox="0 0 47 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clipRule="evenodd" d="M32.6454 25.7129C35.3283 27.5342 37.2083 30.0017 37.2083 33.2917V39.1667H45.0417V33.2917C45.0417 29.0225 38.0504 26.4962 32.6454 25.7129Z" fill="#C3AEF8" />
                        ...
                        <div className={`card-example-preview ${accordion1 ? "hidden" : "flex"}`}>
                            <div className={`out-link`}>
                                <div className="link-icon">
                                    <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_249_232)">
                            ...
                            <div className="w-100 flex justify-center">
                                <img
                                    src={("/images/classic-cards/Group 5.png")}
                                    className="w-100 h-100"
                                    alt=""
                                />
                            </div>
                    ...
                    <div className="listed-card card-services-details flex align-center">
                        <div className="card-color-selector flex item-center">
                            ...
                            <div className="bold ml-15 paragraph flex justify-between align-center w-100">
                                ...
                                <span className={`link-icon mobile-accordion-btn ${accordion2 ? "open" : "closed"}`} onClick={() => setAccordion2(!accordion2)}>
                        ...
                        <div className={`card-composition mobile-accordion-elements ${accordion2 ? "card-hidden-elements" : ""}`}>
                            <p className="text-third mb-10">Matière</p>
                            <p className="paragraph">PVC</p>
                        </div>
                        <div className={`card-feature-box ${accordion2 ? "hidden" : "flex mb-30"}`}>
                            <div className="card-feature">
                                <div className="item-icon">
                                    <svg width="47" height="47" viewBox="0 0 47 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clipRule="evenodd" d="M32.6454 25.7129C35.3283 27.5342 37.2083 30.0017 37.2083 33.2917V39.1667H45.0417V33.2917C45.0417 29.0225 38.0504 26.4962 32.6454 25.7129Z" fill="#C3AEF8" />
                        ...
                        <div className={`card-example-preview ${accordion2 ? "hidden" : "flex"}`}>
                            <div className={`out-link`}>
                                <div className="link-icon">
                                    <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_249_232)">
            ...
            <div className="section-wrapper inner-section-padding">

                <div className="intro-title-group max-x-pad">
                ...
                <div className="empty-cards flex gap-10 mt-3 max-x-pad">
            ...
            <div className="section-wrapper inner-section classic-feature-02 max-x-pad">
...
function AccordionElements({ accordion, setAccordion }) {
    return (
        <>
            <div className={`card-feature-box ${accordion ? "hidden mb-0" : "flex"}`}>
                <div className="card-feature">
                    <div className="item-icon">
                        <svg width="47" height="47" viewBox="0 0 47 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clipRule="evenodd" d="M32.6454 25.7129C35.3283 27.5342 37.2083 30.0017 37.2083 33.2917V39.1667H45.0417V33.2917C45.0417 29.0225 38.0504 26.4962 32.6454 25.7129Z" fill="#C3AEF8" />
            ...
            <div className={`card-example-preview ${accordion ? "hidden" : "flex"}`}>
                <div className={`out-link`}>
                    <div className="link-icon">
                        <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clipPath="url(#clip0_249_232)">
