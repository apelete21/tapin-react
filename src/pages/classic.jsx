        ...
        <>
                ...
                <div className="classic-models">
                    ...
                    <div className="cards-container">
                        <div className="card-element">
                            <div className="card">
                                <img src={require("../images/classic-cards/Group 2.png")} alt="" />
                            </div>
                        ...
                        <div className="card-element">
                            <div className="card">
                                <img src={require("../images/classic-cards/Group 4.png")} alt="" />
                            </div>
                            <span className="card-title text-center paragraph">
                                Nom du modèle
                            </span>
                        ...
                        <div className="card-element">
                            <div className="card">
                                <img src={require("../images/classic-cards/Group 5.png")} alt="" />
                            </div>
                            <span className="card-title text-center paragraph">
                                Nom du modèle
                            </span>
                        ...
                        <div className="card-element">
                            <div className="card">
                                <img src={require("../images/classic-cards/Group 7.png")} alt="" />
                            </div>
                            <span className="card-title text-center paragraph">
                                Nom du modèle
                            </span>
                        ...
                        <div className="card-element">
                            <div className="card">
                                <img src={require("../images/classic-cards/image 78.png")} alt="" />
                            </div>
                            <span className="card-title text-center paragraph">
                                Nom du modèle
                            </span>
            ...
            <div className="section-wrapper inner-section-padding inner-section sm-bottom-padding">
                <div className="section-content-wrapper">
                    ...
                    <div className="classic-demo-cover">
                        <img src={require("../images/virtual-cards.png")} alt="" />
                    </div>
                </div>
            </div>
                ...
                <div className="options-container ">
                    <div className="option-element">
                        <div className="option-img">
                            <img src={require("../images/interaction1.png")} alt="" />
                        </div>
                    ...
                    <div className="option-element">
                        <div className="option-img">
                            <img src={require("../images/interaction2.png")} alt="" />
                        </div>
                        <div className="option-text text-second">
                            Explorez une nouvelle dimension d'interactions professionnelles
                        </div>
                ...
                <div className="listed-card-wrapper">
                    ...
                    <div className="listed-card flex">
                                    ...
                                    <div className="card-feature">
                                        <div className="item-icon">
                                            <svg width="47" height="47" viewBox="0 0 47 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M32.6454 25.7129C35.3283 27.5342 37.2083 30.0017 37.2083 33.2917V39.1667H45.0417V33.2917C45.0417 29.0225 38.0504 26.4962 32.6454 25.7129Z" fill="#C3AEF8" />
                        ...
                        <div className="card-preview w-25">
                            <div className="w-100">
                                <img
                                    src={require("../images/classic-cards/image 78.png")}
                    ...
                    <div className="listed-card card-services-details flex">
                        ...
                        <div className="card-diagonal">
                            <img src={require("../images/card-diagonal-blue.png")} alt="" />
                        </div>
                    </div>
                    <div className="listed-card card-services-details flex">
                        <div className="card-color-selector flex item-center">
                            <img src={require("../images/selector-marron.svg")} alt="" />
                        ...
                        <div className="card-diagonal">
                            <img src={require("../images/card-diagonal.png")} alt="" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="section-wrapper inner-section inner-section-padding card-preview">
                ...
                <div className="empty-cards flex justify-center gap-10">
                    <img src={require("../images/empty-card.png")} alt="" />
                    <img src={require("../images/empty-card.png")} alt="" />
                    <img src={require("../images/empty-card.png")} alt="" />
                    <img src={require("../images/empty-card.png")} alt="" />
                    <img src={require("../images/empty-card.png")} alt="" />
            ...
            <div className="section-wrapper inner-section md-section-padding inner-configurator sm-bottom-padding bg-slate">
                ...
                <div className="img-wrapper">
                    <img src={require("../images/petalcard.png")} className="config-preview" alt="" />
                </div>
            </div>
                ...
                <div className="features-wrapper">
                    ...
                    <div className="features-box">
                        <div className="features-img">
                            <img src={require("../images/exploring.png")} alt="" />
                        </div>
                    ...
                    <div className="features-box">
                        <div className="features-img">
                            <img src={require("../images/exploring2.png")} alt="" />
                        </div>
                        <div className="features-text-wrapper">
                            <h5 className="bold mb-10">Explorez une nouvelle dimension</h5>
                            <p className="main-paragraph">
            ...
            <div className="section-wrapper go-to-classic inner-section md-section-padding">
                ...
                <div className="switch-card  mb-10">
                    <img src={require("../images/classic-cards/image 78.png")} className="" alt="" />
                </div>
